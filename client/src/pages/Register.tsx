...
import { Eye, EyeOff, AlertTriangle, Mail, Lock, User, Phone, MapPin } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterData & { confirmPassword: string }) => {
    try {
      if (!userLocation) {
        toast.error('Please get your location or enter it manually');
        return;
      }
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                >
              ...
              {!userLocation && (
                <p className="mt-1 text-sm text-gray-500">
                  Click "Get Location" to automatically detect your location
                </p>
              )}
            </div>
